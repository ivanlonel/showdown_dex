...
CREATE TABLE IF NOT EXISTS pokemon_event_ability (
	...
	FOREIGN KEY (ability_id, pokemon_id) REFERENCES pokemon_ability (ability_id, pokemon_id)
);
...
CREATE TABLE IF NOT EXISTS analysis (
	...
	pokemon_id text NOT NULL REFERENCES pokemon,
	gen smallint NOT NULL REFERENCES generation (gen_id),
	lang text NOT NULL,
...
CREATE TABLE IF NOT EXISTS moveset (
	...
	moveset_name text,
	pokemon text NOT NULL REFERENCES pokemon (pokemon_id),
	shiny boolean,
	gender text,
	lvl smallint,
...
CREATE TABLE IF NOT EXISTS moveset_ability (
	...
	PRIMARY KEY (analysis_id, moveset_index, ability_id),
...
CREATE TABLE IF NOT EXISTS moveset_item (
	...
	moveset_index smallint,
	item_id text REFERENCES item,
	PRIMARY KEY (analysis_id, moveset_index, item_id),
	FOREIGN KEY (analysis_id, moveset_index) REFERENCES moveset
);
...
CREATE TABLE IF NOT EXISTS moveset_move (
	...
	move_id text REFERENCES t_move,
	PRIMARY KEY (analysis_id, moveset_index, slot, move_id),
	FOREIGN KEY (analysis_id, moveset_index) REFERENCES moveset
);
